...
class ViewTests(unittest.TestCase):
	...
	def test_heatmap(self):
		...
		self.assertEqual(result['sampleGroups']['Haemopedia'], ['celltype', 'cell_lineage', 'tissue', 'surface_markers'])
	...
	def test_showExpression(self):
		...
		self.assertEqual(set(result['sampleIdsFromSampleGroups']['celltype']['RegT']), set(['iltp1786a-03','iltp1786a-04','iltp1786a-05']))
...
class UserViewTests(unittest.TestCase):
    ...
    def test_group_pages(self):
        ...
        hiltonpage = {'url': '/grouppages/HiltonLab/samples', 'group': 'HiltonLab', 'display': 'View/edit all Hiltonlab sample data'}
