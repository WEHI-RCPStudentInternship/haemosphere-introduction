...
{	
	...
	var sampleGroupItems = ${json.dumps(sampleGroupItems) | n};	// {'cell_lineage': {}, 'celltype': {'cell_lineage': {'Cell Line':['FD',...], ... }, ... }, ... }
	var sampleIdsFromSampleGroups = ${json.dumps(sampleIdsFromSampleGroups) | n};
	var sampleGroupColours = ${json.dumps(sampleGroupColours) | n};
